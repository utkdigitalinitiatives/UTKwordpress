...
class BoostrapShortcodes {
  ...
  */
  ...
  function bs_collapse( $atts, $content = null ) {
    ...
    return sprintf( 
      '<div class="panel  %1$s"%2$s><div class="panel-heading"><h3 class="panel-title"><a class="%3$s" data-toggle="collapse"%4$s href="#%5$s"  aria-expanded="true" aria-controls="#%5$s"><i class="icon-fa-chevron-down"></i> %6$s</a></h3></div><div id="%5$s" class="panel-collapse collapse %7$s"><div class="panel-body">%8$s</div></div></div>',
